...
export default function OnePost() {
  ...
  return (
    <div class="body">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" class="arrow logo" width="44" height="44" viewBox="0 0 24 24"><path d="M0 12l9-8v6h15v4h-15v6z"/></svg>
       </a>
        {/* <h2 class="title">{postData.title}</h2>
        <div class="author">
            <h4>Author: Donnie Underwood</h4>
          <h4 class="authorName">{postData.name}</h4> */}
        {/* </div> */}
      <img class ="blogImage" src={urlFor(postData.mainImage).width(600).url()} alt="/"></img>
      </div>
